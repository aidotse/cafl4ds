...
Until this gate passes, an ambiguous health reading is uninterpretable. ([P0.1](P0.1.md)) showed RankMe **falling**
...
At the bounded (P0.1) horizon the gate passes iff **all** hold:
